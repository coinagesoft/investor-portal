                ...
                <ul className="list-group list-group-flush">
                  ...
                  <li className="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div className="d-flex">
                      <div className="flex-shrink-0 me-3">
                        <div className="avatar">
                          <img src="./assets/img/avatars/2.png" alt ="true" className="rounded-circle" />
                        </div>
                      </div>
                      <div className="flex-grow-1">
                  ...
                  <li className="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div className="d-flex">
                      <div className="flex-shrink-0 me-3">
                        <div className="avatar">
                          <img src="./assets/img/avatars/9.png" alt ="true" className="rounded-circle" />
                        </div>
                      </div>
                      <div className="flex-grow-1">
                  ...
                  <li className="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div className="d-flex">
                      <div className="flex-shrink-0 me-3">
                        <div className="avatar">
                          <img src="./assets/img/avatars/5.png" alt ="true" className="rounded-circle" />
                        </div>
                      </div>
                      <div className="flex-grow-1">
                  ...
                  <li className="list-group-item list-group-item-action dropdown-notifications-item">
                    <div className="d-flex">
                      <div className="flex-shrink-0 me-3">
                        <div className="avatar">
                          <img src="./assets/img/avatars/6.png" alt ="true" className="rounded-circle" />
                        </div>
                      </div>
                      <div className="flex-grow-1">
